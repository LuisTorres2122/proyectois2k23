...
namespace CxPVista
{
    public partial class AyudaFactura : Form
    {
        ...
        public AyudaFactura(string tabla, TextBox txtIdFactura, TextBox txtIdAlmacen, TextBox txtSaldo, TextBox txtIdProveedor, TextBox txtEmision, TextBox txtIdCuenta, TextBox txtMonto)
        {
            InitializeComponent();
            table = tabla;
