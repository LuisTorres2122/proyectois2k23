...
namespace CxPModelo
{
    public class JSentencia
    {
        ...
        public OdbcDataAdapter llenarTablaFactura(string tabla)// metodo  que obtinene el contenio de una tabla
        {
            ...
            string sql = "SELECT pk_id_factura as IdFactura, pk_id_almacen as IdAlmacen, pk_id_proveedor as IdProveedor, fecha_emision_factura as FechaEmision, total_factura as TotalFactura, estatus_factura as Estado FROM " + tabla;
